...
import MintWidgetEOS from './MintWidgetEOS';
...
export default class DappEOS extends React.Component<Props, State> {
  ...
  componentDidMount = async () => {
    ...
    if (browserProvider?.isMetaMask !== true) {
      this.setError( 
        <>
          We were not able to detect <strong>MetaMask</strong>. If you are on mobile, you must use Metamask's in-app Browser as trying to mint from Chrome/Firefox/Safari will not work. <br />
          <br />
            ...
            <div className="nft-content__wrapper">
              ...
              <div className="wrap-horizontal">
                ...
                <div className="mint-detail__wrapper">
                  ...
                  <p className="p nospace"><span className="text-span-14">350</span> of <span className="text-span-13">350 </span><br/>NFTs have been minted.</p>
                </div>
              </div>
